...
/* configure the MCU pins as 1- INPUT
							2- OUTPUT
							*/
...
/*configure the MCU pins to initial value in case of input diriction 1- FLOUTING
 * 													 				 2- PULLED_UP
 *
 * 										in case of output diriction  1- LOW
 * 																	2- HIGH	*/
 ...
 #define PORTC_PIN0_INIT_VAL		FLOUTING
 #define PORTC_PIN1_INIT_VAL		FLOUTING
 #define PORTC_PIN2_INIT_VAL		FLOUTING
 #define PORTC_PIN3_INIT_VAL		FLOUTING
 #define PORTC_PIN4_INIT_VAL		FLOUTING
 #define PORTC_PIN5_INIT_VAL		FLOUTING
 #define PORTC_PIN6_INIT_VAL		FLOUTING
 #define PORTC_PIN7_INIT_VAL		FLOUTING
